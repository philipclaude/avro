...
class MatrixBlock_2x2 : public BlockMatrixType< MatrixBlock_2x2<Matrix00, Matrix01,
                                                                Matrix10, Matrix11> >,
                        public blockType< MatrixBlock_2x2<Matrix00, Matrix01,
                                                                Matrix10, Matrix11> >
{
public:
  ...
  template<class Expr> MatrixBlock_2x2& operator= ( const blockType<Expr>& );
  template<class Expr> MatrixBlock_2x2& operator+=( const blockType<Expr>& );
  template<class Expr> MatrixBlock_2x2& operator-=( const blockType<Expr>& );
  template<class Expr> MatrixBlock_2x2& operator*=( const blockType<Expr>& );
...
inline MatrixBlock_2x2<Matrix00, Matrix01, Matrix10, Matrix11>&
MatrixBlock_2x2< Matrix00, Matrix01,
                 Matrix10, Matrix11 >::operator=(const blockType<Expr>& expr)
{
