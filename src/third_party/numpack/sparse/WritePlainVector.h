...
#ifndef SRC_LINEARALGEBRA_sparse_WRITEPLAINVECTOR_H_
#define SRC_LINEARALGEBRA_sparse_WRITEPLAINVECTOR_H_
...
#endif /* SRC_LINEARALGEBRA_sparse_WRITEPLAINVECTOR_H_ */
