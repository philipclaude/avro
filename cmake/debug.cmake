...
list(APPEND MEMCHECK_FLAGS --suppressions=${CMAKE_SOURCE_DIR}/cmake/supp/osx )
list(APPEND MEMCHECK_FLAGS --suppressions=${CMAKE_SOURCE_DIR}/cmake/supp/ubuntu )
...
if( BUILD_TYPE AND BUILD_TYPE MATCHES "DEBUG" )
  ...
  set( STACKCHECK_COMMAND ${STACKCHECK_COMMAND} --suppressions=${CMAKE_SOURCE_DIR}/cmake/supp/stackcheck )
else()
