...
$avro -adapt $2/meshes/cube-cylinder.mesh $2/geometry/cube-cylinder.egads Polar1 $3/ccp1 rho=false write_conformity=true href=1.7 > ccp1.txt &
...
$avro -conformity $3/cl_9.mesh Linear-3d $3/cl_conformity.json nb_expected=39000
status_cl=$?
echo "status CL = $status_cl"

$avro -conformity $3/ccl_9.mesh Linear-3d $3/ccl_conformity.json nb_expected=31400
status_ccl=$?
...
$avro -conformity $3/ccp1_9.mesh Polar1 $3/ccp1_conformity.json nb_expected=21000
status_ccp1=$?
echo "status CCP1 = $status_ccp1"

$avro -conformity $3/ccp2_9.mesh Polar2  $3/ccp2_conformity.json nb_expected=32000
status_ccp2=$?
