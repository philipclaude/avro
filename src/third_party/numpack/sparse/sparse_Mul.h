...
class OpMatMulVec : public sparseType< OpMatMulVec< Matrix_type, TV >, true >
{
public:
...
operator*(const std::shared_ptr< SparseMatrix_CRS<TM> >& eL, const sparseType<ExprR, useRFR>& eR)
{
  return OpMul< SparseMatrix_CRS<TM>, ExprR>( *eL.get(), eR.cast() );
}

// Multiplication between a sparse expression and a scalar quantity
...
template<class Expr>
class OpMulScalar<Expr, true> : public sparseType< OpMulScalar<Expr, true>, true >
{
public:
...
template<class Expr>
class OpMulScalar<Expr, false> : public sparseType< OpMulScalar<Expr, false>, false >
{
public:
  typedef typename Expr::Ttype Ttype;
...
operator-(sparseType<Expr, useRF> const& e)
{
...
class OpMulFactor< OpMulScalar<ExprL, useRFL>, ExprR > : public sparseType< OpMulFactor< OpMulScalar<ExprL, useRFL>, ExprR >, true >
{
public:
...
class OpMulFactor< ExprL, OpMulScalar<ExprR, useRFR> > : public sparseType< OpMulFactor< ExprL, OpMulScalar<ExprR, useRFR> >, true >
{
public:
  typedef typename ExprL::Ttype Ttype;
...
operator*(const OpMulScalar<ExprL, useRFL>& eL, const sparseType<ExprR, useRFR>& eR)
{
...
operator*(const sparseType<ExprL, useRFL>& eL, const OpMulScalar<ExprR, useRFR>& eR)
{
...
template<class TM, class TV>
class OpMatMulVec<SparseNonZeroPattern<TM>, TV> : public sparseType< OpMatMulVec< SparseNonZeroPattern<TM>, TV >, true >
{
public:
