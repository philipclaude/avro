...
class VectorBlock_3 : public BlockVectorType< VectorBlock_3<Vector0, Vector1, Vector2> >,
                      public blockType< VectorBlock_3<Vector0, Vector1, Vector2> >
{
public:
  ...
  template< class Expr > inline VectorBlock_3& operator=( const blockType<Expr>& r );
  template< class Expr > inline VectorBlock_3& operator+=( const blockType<Expr>& r );
  template< class Expr > inline VectorBlock_3& operator-=( const blockType<Expr>& r );
...
VectorBlock_3< Vector0, Vector1, Vector2 >::operator=( const blockType<Expr>& r )
{
