...
#ifndef SRC_LINEARALGEBRA_block_VECTORBLOCK_4_H_
#define SRC_LINEARALGEBRA_block_VECTORBLOCK_4_H_
...
class VectorBlock_4 : public BlockVectorType< VectorBlock_4<Vector0,Vector1,Vector2,Vector3> >,
                      public blockType< VectorBlock_4<Vector0,Vector1,Vector2,Vector3> >
{
public:
  ...
  template<class Expr> inline VectorBlock_4& operator=(const blockType<Expr>& r);
...
operator=(const blockType<Expr>& r)
{
...
#endif /* SRC_LINEARALGEBRA_block_VECTORBLOCK_4_H_ */
