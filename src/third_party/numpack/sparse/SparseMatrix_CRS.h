...
template<class TM>
class SparseMatrix_CRS : public sparseType< SparseMatrix_CRS<TM>, true >,
...
template<class TM>
class SparseMatrix_CRS< DLA::MatrixD<TM> > : public sparseType< SparseMatrix_CRS< DLA::MatrixD<TM> >, true >,
