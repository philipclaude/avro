...
class VectorBlock_2 : public BlockVectorType< VectorBlock_2<Vector0, Vector1> >,
                      public blockType< VectorBlock_2<Vector0, Vector1> >
{
public:
  ...
  template< class Expr > inline VectorBlock_2& operator=( const blockType<Expr>& r );
  template< class Expr > inline VectorBlock_2& operator+=( const blockType<Expr>& r );
  template< class Expr > inline VectorBlock_2& operator-=( const blockType<Expr>& r );
...
VectorBlock_2< Vector0, Vector1 >::operator=( const blockType<Expr>& r )
{
