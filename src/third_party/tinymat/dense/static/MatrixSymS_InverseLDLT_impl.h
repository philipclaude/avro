...
#if !defined(MATRIXSYMS_INVERSELDLT_INSTANTIATE) && !defined(SANS_HEADERCOMPILE_CHECK)
...
void MatrixSymSLDLTSolver<M, N, T, MatrixType>::Solve( const FactorType& Factorized, const Real sgn, MatrixType& res )
{
