...
if (NOT LUNA_USE_CPP11)
  if (LUNA_CPU_THREADING STREQUAL "cpp11")
    message( STATUS "cannot use cpp11 threads: setting emp" )
    set( LUNA_CPU_THREADING "emp" )
  endif()
  if (NOT LUNA_SMART_PTR)
    message( STATUS "using internal smart pointers since not cpp11 (shared_ptr)" )
    set(LUNA_SMART_PTR true)
  endif()
endif()
...
if (LUNA_GPU_THREAD_MANAGER STREQUAL "cuda")
  ...
  add_definitions(-DLUNA_GPU_THREAD_MANAGER_CUDA)
  set(LUNA_WITH_CUDA true )
elseif( LUNA_GPU_THREADING STREQUAL "opencl" )
  ...
  add_definitions(-DLUNA_GPU_THREAD_MANAGER_OPENCL)
  set(LUNA_WITH_OPENCL true)
