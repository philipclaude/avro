...
det(const matd<type>& X)
{
  ...
  type X1_5=X(0,4),X2_5=X(1,4),X3_5=X(2,4),X4_5=X(3,4);
  type X5_1=X(4,0),X5_2=X(4,1),X5_3=X(4,2),X5_4=X(4,3),X5_5=X(4,4);
  if (X.m()==5)
  {
    return
  ...
  type X1_6=X(0,5),X2_6=X(1,5),X3_6=X(2,5),X4_6=X(3,5),X5_6=X(4,5);
  type X6_1=X(5,0),X6_2=X(5,1),X6_3=X(5,2),X6_4=X(5,3),X6_5=X(5,4),X6_6=X(5,5);
  if (X.n()==6)
  {
    return
