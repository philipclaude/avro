...
#include "numpack/DenseLinAlg/DynamicSize/MatrixD_Norm.h"
...
#include "numpack/SparseLinAlg/WritePlainVector.h"

#include "numpack/SparseLinAlg/WriteMatrixMarketFile.h"
namespace numpack 
{
namespace SLA
{
