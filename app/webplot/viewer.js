...
function wvServerDown()
{
    ...
    postMessage("The server has terminated or network connection has been lost.","red");
}

function drawColorbar(gl)
{
  //return;
  ...
  {
    // remove the limits
    var textDiv_lo = document.getElementById("colorbartext_lo");
    textDiv_lo.innerHTML = "";
    var textDiv_hi = document.getElementById("colorbartext_hi");
  ...
  wv.checkGLError(gl, "drawColorbar");
...
function resizeFrames()
{
    ...
    treefrm.style.height = (topHeight-200)+"px";
    butnfrm.style.height = 350+"px";
...
//
function postMessage(mesg,col,newline,brackets)
{
    ...
    term.postMessage(pre+mesg+end,col,newline);
}
