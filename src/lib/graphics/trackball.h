#ifndef AVRO_LIB_GRAPHICS_TRACKBALL_H_
#define AVRO_LIB_GRAPHICS_TRACKBALL_H_
...
public:
  ...
  Controller( float fov , int width , int height , float znear=0.1f , float zfar=100.0f );
