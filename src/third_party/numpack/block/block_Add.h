...
namespace BLA
{
// Addition and Subtraction of blockType (vector, matrix or expression)
//
...
class OpAdd : public blockType< OpAdd<ExprL, ExprR> >
{
public:
...
//---------------------------------------------------------------------------//
template<class ExprL, class ExprR>
class OpSub : public blockType< OpSub<ExprL, ExprR> >
{
public:
