...
template<class TM_>
class SparseMatrix_CRS_Transpose : public sparseType< SparseMatrix_CRS_Transpose<TM_>, true >,
...
//Represents the transpose of a matrix
template<class TM_>
class SparseMatrix_CRS_Transpose< DLA::MatrixD<TM_> > : public sparseType< SparseMatrix_CRS_Transpose< DLA::MatrixD<TM_> >, true >
{
protected:
