...
#ifndef SRC_LINEARALGEBRA_block_block_MUL_H_
#define SRC_LINEARALGEBRA_block_block_MUL_H_
...
// Multiplication involving blockType (vector, matrix or expression)

//=============================================================================
// Multiplication between a block matrix or expression with a vector or matrix, including expressions
//
//-----------------------------------------------------------------------------
...
class OpMatMulVec : public blockType< OpMatMulVec<Matrix_type, Vector_type> >
{
public:
...
class OpMatMul : public blockType< OpMatMul<MatrixL_type, MatrixR_type> >
{
public:
...
operator*(const blockType<ExprL>& eL, const blockType<ExprR>& eR)
{
...
//=============================================================================
// Multiplication between a block expression and a scalar quantity
//
//-----------------------------------------------------------------------------
...
//
template<class Expr>
class OpMulScalar : public blockType< OpMulScalar<Expr> >
{
public:
...
operator*(const blockType<Expr>& e, const T& s)
{
...
template<class Expr, typename T>
inline typename std::enable_if<std::is_arithmetic<T>::value, OpMulScalar<Expr>>::type
operator*(const T& s, const blockType<Expr>& e)
{
  return OpMulScalar<Expr>(e.cast(), s);
}
// M = -E
...
operator-(blockType<Expr> const& e)
{
...
//=============================================================================
// block matrix multiplication with vector or matrix that involves a scalar quantity
...
// no temporary variables are required
template<class ExprL, class ExprR>
class OpMulFactor<OpMulScalar<ExprL>, ExprR> : public blockType< OpMulFactor<OpMulScalar<ExprL>, ExprR> >
{
public:
...
// no temporary variables are required
template<class ExprL, class ExprR>
class OpMulFactor<ExprL, OpMulScalar<ExprR>> : public blockType< OpMulFactor<ExprL, OpMulScalar<ExprR>> >
{
public:
...
operator*(const OpMulScalar<ExprL>& eL, const blockType<ExprR>& eR)
{
...
operator*(const blockType<ExprL>& eL, const OpMulScalar<ExprR>& eR)
{
...
#endif /* SRC_LINEARALGEBRA_block_block_MUL_H_ */
