...
#ifndef SRC_LINEARALGEBRA_block_MATRIXBLOCK_4X4_H_
#define SRC_LINEARALGEBRA_block_MATRIXBLOCK_4X4_H_
...
class MatrixBlock_4x4 : public BlockMatrixType< MatrixBlock_4x4<Matrix00, Matrix01, Matrix02, Matrix03,
                        ...
                        public blockType< MatrixBlock_4x4<Matrix00, Matrix01, Matrix02, Matrix03,
                                                                Matrix10, Matrix11, Matrix12, Matrix13,
                                                                Matrix20, Matrix21, Matrix22, Matrix23,
                                                                Matrix30, Matrix31, Matrix32, Matrix33> >
{
public:
...
#if 0 // not unit tested yet
  template<class Expr> MatrixBlock_4x4& operator=(const blockType<Expr>& expr)
  {
  ...
  template<class Expr> inline MatrixBlock_4x4& operator+=(const blockType<Expr>& expr)
  {
    const Expr& Tree = expr.cast();
    Tree.plus(1,*this);
    return *this;
  ...
  template<class Expr> MatrixBlock_4x4& operator*=( const blockType<Expr>& );
#endif
...
#endif /* SRC_LINEARALGEBRA_block_MATRIXBLOCK_4X4_H_ */
