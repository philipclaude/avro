...
REAL orient3dadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL permanent)
{
  ...
  // pcaplan allocate capacity+1 storage because fast_expansion_sum_zeroelim
  // may access the last entry (without using it)
  REAL at_b[5], at_c[5], bt_c[5], bt_a[5], ct_a[5], ct_b[5];
