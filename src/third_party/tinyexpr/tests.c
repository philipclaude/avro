...
void test_dynamic() {
    ...
    te_variable lookup[] = {
        {"x", &x},
        {"f", &f},
        {"sum0", (void*)&sum0, TE_FUNCTION0}, // pcaplan modified to (void*)
        {"sum1", (void*)&sum1, TE_FUNCTION1},
        {"sum2", (void*)&sum2, TE_FUNCTION2},
        {"sum3", (void*)&sum3, TE_FUNCTION3},
        {"sum4", (void*)&sum4, TE_FUNCTION4},
        {"sum5", (void*)&sum5, TE_FUNCTION5},
        {"sum6", (void*)&sum6, TE_FUNCTION6},
        {"sum7", (void*)&sum7, TE_FUNCTION7},
    };
